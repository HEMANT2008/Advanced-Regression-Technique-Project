# Advanced-Regression-Technique-Project
...
#####################  About Data  ########################################
MSSubClass: Identifies the type of dwelling  (nivastan) involved in the sale.	
...
Alley: Type of alley access to property(galli)

       Grvl	Gravel
       Pave	Paved
       NA 	No alley access  (mhanje tithe galli nahi ektyat ahe ghar)
